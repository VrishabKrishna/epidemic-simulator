...
function get_kappa_no_intervention(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_SC(nodes, homes, workplaces, communities, cur_time) {
    for (var count = 0; count < nodes.length; count++) {
        ...
        if (
            nodes[count]["compliant"] &&
            time_since_symptoms >
                NUM_DAYS_TO_RECOG_SYMPTOMS * SIM_STEPS_PER_DAY &&
            time_since_symptoms <=
                (NUM_DAYS_TO_RECOG_SYMPTOMS + SELF_ISOLATION_DAYS) *
                    SIM_STEPS_PER_DAY
        ) {
...
function get_kappa_case_isolation(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_home_quarantine(
    nodes,
    homes,
    workplaces,
    communities,
    ...
    for (var count = 0; count < nodes.length; count++) {
        ...
        if (
            ...
            time_since_symptoms >
                NUM_DAYS_TO_RECOG_SYMPTOMS * SIM_STEPS_PER_DAY &&
            time_since_symptoms <=
                (NUM_DAYS_TO_RECOG_SYMPTOMS + HOME_QUARANTINE_DAYS) *
                    SIM_STEPS_PER_DAY
        ) {
...
function get_kappa_CI_HQ_70P_SC(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_CI_HQ_70P_SC_OE(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_LOCKDOWN_40_CI_HQ_SD_70_PLUS_21_CI(
    nodes,
    homes,
    workplaces,
    communities,
    ...
    if (
        cur_time <
        (NUM_DAYS_BEFORE_INTERVENTIONS + FIRST_PERIOD) * SIM_STEPS_PER_DAY
    ) {
        get_kappa_lockdown(nodes, homes, workplaces, communities, cur_time);
    } else if (
        cur_time <
        (NUM_DAYS_BEFORE_INTERVENTIONS + FIRST_PERIOD + SECOND_PERIOD) *
            SIM_STEPS_PER_DAY
    ) {
...
function get_kappa_LOCKDOWN_40(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_LD_40_CI_HQ_SD70_SC_21_SC_42(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_LD_40_CI_HQ_SD70_SC_21(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_LD_40_CI_HQ_SD70_SC_OE_30(
    nodes,
    homes,
    workplaces,
    communities,
...
function get_kappa_CALIBRATION(
    nodes,
    homes,
    workplaces,
    communities,
